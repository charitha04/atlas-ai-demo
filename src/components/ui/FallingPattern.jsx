...
/**
 * FallingPattern - Animated falling rain/pattern background effect
 * 
 * @param {Object} props
 * @param {string} [props.color='#1A9375'] - Primary color of the falling elements
 * @param {string} [props.backgroundColor='#f4f4f4'] - Background color
 * @param {number} [props.duration=150] - Animation duration in seconds
 * @param {string} [props.blurIntensity='1em'] - Blur intensity for overlay effect
 * @param {number} [props.density=1] - Pattern density - affects spacing
